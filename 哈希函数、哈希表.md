...
![image-20220802094828810](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220802094828810.png)



根据根节点确定左右子树的值范围，然后递归左右子树
...
### 借助栈或者队列。每次插入根节点的左中子节点两个元素，然后取出来比较
    ...
    public List<List<Integer>> levelOrder(TreeNode root) {
        ...
        while(!deque.isEmpty()){
            ...
            for(int i = 0 ; i < flag; i++){
                TreeNode tem = deque.poll();
                list.add(tem.val);
                if(tem.left!=null){
                    deque.offer(tem.left);
                }
                if(tem.right!=null){
                    deque.offer(tem.right);
                }
            }
            res.add(list);
        ...
        if(left1>right1){
           ...
           for(int i = left2;i<=right2;i++){
               if(inorder[i]==preorder[left1]){
                   int len = i-left2;//一定要计算长度，不然有可能对不上
                   root.left = dfs(preorder,inorder,left1+1,left1+len,left2,i-1);
                   root.right=dfs(preorder,inorder,left1+len+1,right1,i+1,right2);
               }
        }
        return root;
    }
...
![image-20220808101249722](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220808101249722.png)
...
![image-20220808101908451](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220808101908451.png)
...
class Solution {
    public int maxPathSum(TreeNode root) {
        double[] res = dfs(root);
        return (int)(Math.max(res[1],res[0]));
    }
    public double[] dfs(TreeNode root){
        if(root==null){
            return new double[]{Double.MIN_VALUE,Integer.MIN_VALUE};
        }
        double[] res = new double[2];
        double[] left = dfs(root.left);
        double[] right = dfs(root.right);
        res[0] = root.val+Math.max(Math.max(left[0],right[0]),0);
        res[1] = Math.max(Math.max(Math.max(left[1],right[1]),root.val+left[0]+right[0]),res[0]);
        return res;
...
![image-20220809094917697](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220809094917697.png)
...
![image-20220815084012284](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220815084012284.png)
...
![image-20220815085057886](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220815085057886.png)
...
}tack.push(new int[]{x, Math.min(x, stack.peek()[1])});
        }
    }
...
![image-20220815091352055](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220815091352055.png)
...
作者：windliang
链接：https://leetcode.cn/problems/min-stack/solution/xiang-xi-tong-su-de-si-lu-fen-xi-duo-jie-fa-by-38/
来源：力扣（LeetCode）
著作权归作者所有。商业转载请联系作者获得授权，非商业转载请注明出处。
```
...
![image-20220815092617982](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220815092617982.png)
...
![image-20220815093116023](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220815093116023.png)
...
class Solution {
    public int rob(int[] nums) {
        ...
        for(int i = 1 ; i < nums.length;i++){
            int tem = tou;
            tou = nums[i]+butou;
            butou = Math.max(tem,butou);
            res = Math.max(res,tou);
        }
        return res;
...
![image-20220816203949781](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220816203949781.png)
...
![image-20220818092615563](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220818092615563.png)
...
![image-20220818092117051](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220818092117051.png)
...
![image-20220818094226385](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220818094226385.png)
...
![image-20220818100647366](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220818100647366.png)



[1277. 统计全为 1 的正方形子矩阵的官方题解](https://leetcode-cn.com/problems/count-square-submatrices-with-all-ones/solution/tong-ji-quan-wei-1-de-zheng-fang-xing-zi-ju-zhen-2/)
...
![image-20220818094030983](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220818094030983.png)
...
![image-20220822092107139](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220822092107139.png)
...
![image-20220822094436713](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220822094436713.png)
...
由于我们需要求出的是滑动窗口的最大值，如果当前的滑动窗口中有两个下标 i 和 j，其中 ii 在 jj 的左侧（i < j），并且 ii 对应的元素不大于 j 对应的元素nums[i]≤nums[j]，那么会发生什么呢？

当滑动窗口向右移动时，只要 ii 还在窗口中，那么 jj 一定也还在窗口中，这是 ii 在 jj 的左侧所保证的。因此，由于 nums[j] 的存在，nums[i] 一定不会是滑动窗口中的最大值了，我们可以将 nums[i] 永久地移除。

因此我们可以使用一个队列存储所有还没有被移除的下标。在队列中，这些下标按照从小到大的顺序被存储，并且它们在数组nums 中对应的值是严格单调递减的。因为如果队列中有两个相邻的下标，它们对应的值相等或者递增，那么令前者为 ii，后者为 jj，就对应了上面所说的情况，即 nums[i] 会被移除，这就产生了矛盾。
...
我们先设置慢指针 \textit{slow}slow 和快指针fast ，慢指针每次走一步，快指针每次走两步，根据「Floyd 判圈算法」两个指针在有环的情况下一定会相遇，此时我们再将 \textit{slow}*slow* 放置起点 00，两个指针每次同时移动一步，相遇的点就是答案。
...
public class Codec {
    ...
    public TreeNode deserializeList(List<String> list){
...
![image-20220829092323849](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220829092323849.png)
...
作者：LeetCode-Solution
链接：https://leetcode.cn/problems/remove-invalid-parentheses/solution/shan-chu-wu-xiao-de-gua-hao-by-leetcode-9w8au/
来源：力扣（LeetCode）
著作权归作者所有。商业转载请联系作者获得授权，非商业转载请注明出处。
```
...
利用Brian Kernighan 算法，可以在一定程度上进一步提升计算速度。Brian Kernighan 算法的原理是：对于任意整数 xx，令 x=x & (x−1)，该运算将 x 的二进制表示的最后一个 1变成 0。因此，对 xx 重复该操作，直到 x变成 0，则操作次数即为 x的「一比特数」。
...
作者：cxywushixiong
链接：https://leetcode.cn/problems/top-k-frequent-elements/solution/leetcode-di-347-hao-wen-ti-qian-k-ge-gao-pin-yuan-/
来源：力扣（LeetCode）
著作权归作者所有。商业转载请联系作者获得授权，非商业转载请注明出处。
```
...
![image-20220923100455269](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220923100455269.png)
...
### 高度从小到大，前面人数从大到小排序，然后留出空位

![image-20220926093458015](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220926093458015.png)
...
后面插入的不会对前面有影响，前面的每一个对后面依次插入的都有影响，因此只需把要插入的放在list的排序的位置就可以了

![image-20220926094111069](%E5%93%88%E5%B8%8C%E5%87%BD%E6%95%B0%E3%80%81%E5%93%88%E5%B8%8C%E8%A1%A8.assets/image-20220926094111069.png)
